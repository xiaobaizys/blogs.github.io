...
const posts = [
  ...
  },
  {
    ...
    date: '2024-01-10',
    tags: ['前端', 'Vue'],
    excerpt: '探索Vue 3带来的新特性和改进...',
    content: '<p>探索Vue 3带来的新特性和改进...</p>',
  },
  {
    id: 5,
    ...
    date: '2024-01-25',
    tags: ['前端', 'TypeScript'],
    excerpt: '深入理解TypeScript的类型系统...',
    content: '<p>深入理解TypeScript的类型系统...</p>',
  },
  {
    id: 6,
    title: 'Webpack 配置优化',
    date: '2024-02-05',
    tags: ['前端', '构建工具'],
    excerpt: '如何优化Webpack配置提升构建性能...',
    content: '<p>如何优化Webpack配置提升构建性能...</p>',
  }
]
